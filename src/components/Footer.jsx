...
() {
  return (
    <div>
        <footer className="px-4 divide-y bg-violet-950 text-gray-100">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				...
				<span className="self-center text-2xl font-semibold">TOY CARS ZONE</span>
               
			</a>
            <button className='rounded-full bg-zinc-600 px-10 mt-10 ml-10 '>Website Link</button>
		</div>
	...
	<div className="py-6 text-sm text-center text-gray-400">© Mushfiqur Rahman Kaoushik || All rights reserved.</div>
</footer>
